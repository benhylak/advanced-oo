...
public class DataTest implements Iterable<TimedTest>
{
     ...
     *
     * @param N TimedTest method on N elements
    ...
    public long testContains(int N)
    {
        ...
        startClock(); //Start TimedTest Timer

        toTest.contains(toFind); //TimedTest

        return elapsedTime(); //End TimedTest Timer
    }
    ...
    public long testRemove(int N)
    {
        ...
        toTest.remove(toRemove); //TimedTest

        long time = elapsedTime(); //end TimedTest timer
